...
| `AgentPrism.Testing.Contracts.Xunit` | You write your own store (`IRunStore` or another), `IModelProvider`, or `IRunJudge`, and want the behavior contract the shipped implementations run |
