...
| `AgentPrism.Testing.Contracts.Xunit` | You write your own store (`IRunStore` or another), `IModelProvider`, `IRunJudge`, `IAgentSource`, `IJobHandler`, or a custom tool, and want the behavior contract the shipped implementations run |
