...
<CardGrid>
  <Card title="A control plane, not another agent abstraction" icon="puzzle">
    ...
    Tracon adds the operational layer around them without replacing their model.
  </Card>
...
Run it and open `/tracon`. Create an agent, talk to it in the playground, then
...
<figure class="product-shot">
  <a href="/screenshots/dashboard.png">
    <img
      ...
      alt="Tracon dashboard with run volume, error rate, token cost, and recent activity"
      width="2880"
      height="1800"
      loading="lazy"
      decoding="async"
...
<div class="boundary-note">
  ...
  is no account, and Tracon sends no telemetry of its own — nothing is
  reported back to Tracon or to any vendor. What does leave your process is
  ...
  everywhere:
  <code>AddTracon()</code> works with no infrastructure, tools are defined in code
  ...
  wins. <a href="/getting-started/">What Tracon is</a> explains each.
</div>

:::caution[Pre-release]
Tracon has not shipped `1.0`. The ASP.NET Core package depends on preview Microsoft
