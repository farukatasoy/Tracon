...
// (TraconEndpointRouteBuilderExtensions.cs). A client generated straight
// from the document would 404 against any consumer that calls MapTracon
// with a custom prefix. TraconClientOptions.baseUrl carries the prefix
...
export const DEFAULT_PREFIX = '/tracon';
