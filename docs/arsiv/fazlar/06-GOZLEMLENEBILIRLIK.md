...
| Değişiklik | Neden |
|-----------|-------|
| `runs.model_id text` + kısmi indeks | Maliyet ve model kırılımı raporları — fiyat sütunları Faz 20'de eklendi (migration 0011: `input_cost`, `output_cost`, `cost_currency`, `pricing_source`; bkz. `docs/arsiv/fazlar/20-MALIYET-VE-GOSTERGE-PANELI.md`) |
...
8. **İkinci faz planı hazır:** [`arsiv/IKINCI-FAZ-YOL-HARITASI.md`](../IKINCI-FAZ-YOL-HARITASI.md)
