...
3. [`31-GERI-BILDIRIM-VE-PUANLAMA.md`](31-GERI-BILDIRIM-VE-PUANLAMA.md) —
   **planlanan public API bölümünün tamamı** ve devir notu:
   ```bash
   awk '/## Planlanan Public API/,/## Planlanan Dosya/' docs/arsiv/fazlar/31-GERI-BILDIRIM-VE-PUANLAMA.md
   awk '/## Sonraki Faza Devir Notu/,0' docs/arsiv/fazlar/31-GERI-BILDIRIM-VE-PUANLAMA.md
   ```
...
6. 🚨 [`48-GUARDRAILS.md`](48-GUARDRAILS.md) — yalnız devir notu. Faz 48 model
   ...
   ```bash
   awk '/## Sonraki Faza Devir Notu/,0' docs/arsiv/fazlar/48-GUARDRAILS.md
   ```
