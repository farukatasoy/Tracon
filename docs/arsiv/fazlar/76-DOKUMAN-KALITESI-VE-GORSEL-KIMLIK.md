...
> **Paketler:** Yok — bu faz `src/**` altına **hiç dokunmaz** · `docs-site/` · `tests/Tracon.Ui.E2ETests` (yalnız ekran görüntüsü)
...
- [x] `samples/Tracon.Api` ile gerçek `run` yapıldı: `support` agent'ı,
