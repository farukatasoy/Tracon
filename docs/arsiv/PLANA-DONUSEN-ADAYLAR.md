...
**F-225 → [Faz 166 — HTTP Kapasite Ölçümü](fazlar/166-HTTP-KAPASITE-OLCUMU.md)** (2026-09-13): kullanıcı isteğiyle doğrudan plana dönüştü; kapsam ve kanıt faz dokümanındadır.
...
| F-235 | [Faz 172 — Tehdit Modeli](fazlar/172-TEHDIT-MODELI.md) |
...
## 2026-09-15 — Sıralanabilir kuyruğun tamamı plana dönüştü (F-239 · F-224 · F-218 · F-213 · F-232)

Beş kalem aynı gün plana dönüştü ve **sıralanabilir kuyruk boşaldı**. Tur bir
kanıt doğrulama turuydu: `faz-planlama` Adım 1'i beş kalemin **üçünde** kayma
buldu.

| Kalem | Faz | Adım 1'de ne değişti |
|---|---|---|
...
**Kaynak:** [Faz 164](fazlar/164-CONSOLE-ENSTRUMAN-KATMANI.md) — `Dialog`
...
**Kaynak:** [Faz 155](fazlar/155-KALIBRE-EDILMIS-EVALUATOR-KATALOGU.md) — plan
...
[Faz 153](fazlar/153-EVAL-KOSUMLARI-ARASINDA-REGRESYON-FARKI.md)'ün regresyon
...
**Kaynak:** [Faz 152](fazlar/152-SKORUN-ADI-VE-SEKLI.md) — case bilerek
...
**Kaynak:** Kullanıcı fikri (2026-09-15). [Faz 73](fazlar/73-TUKETICI-AGENT-DESTEGI.md)
ve [Faz 167](fazlar/167-AGENT-ZORLAMA-KATMANI.md) hattının devamı.
...
| F-259 | [Faz 182](fazlar/182-PUBLIC-API-YUZEY-DARALTMA.md) |
| F-260 | [Faz 183](fazlar/183-COKLU-TFM-TEST-MATRISI.md) |
| F-261 | [Faz 184](fazlar/184-TEST-BEKLEME-VE-E2E-YAPISI.md) |
...
| Kalem | Faz |
|---|---|
| F-265 | [Faz 185](fazlar/185-KARDES-PAKET-SURUM-SABITLEME.md) |
| F-269 | [Faz 186](fazlar/186-SCRIPT-IZNI-ICERIK-PINI.md) |
| F-270 | [Faz 187](fazlar/187-KIRICI-DEGISIKLIK-KAPISI.md) |
| F-271 | [Faz 188](fazlar/188-DI-KURUCU-DARALTMA.md) + [Faz 189](fazlar/189-TUKETICI-YUZEYI-VE-BUILDER.md) |
| F-272 | [Faz 190](fazlar/190-KIMLIK-BASLIKLARI-ANAHTAR-REFERANSI.md) |
| F-273 | [Faz 191](fazlar/191-TEK-DERLEME-ZINCIRI.md) |
