...
> Spesifikasyon: [`../../03-KALICILIK-POSTGRESQL.md`](../../manuel-test/03-KALICILIK-POSTGRESQL.md)
...
- **Sonraki oturumun işi:** zincirin dördüncü ailesi —
  [`05-SAGLAYICI-OPENAI.md`](../../manuel-test/05-SAGLAYICI-OPENAI.md), 40 case, 2 oturum.
  Bu dosyaya dönme.
- **Bozuk ön koşul:** yok.
