...
| 12 | [`12-GOZLEMLENEBILIRLIK-MALIYET.md`](12-GOZLEMLENEBILIRLIK-MALIYET.md) | `OBS` | 6, 20, 35, 68, 89, 119, 132 | `src/AgentPrism.Core` · `screens/dashboard.tsx` · `screens/run-detail.tsx` | **58** | ✅ | ✅ 35/37 · 2 ⏭ · 9 🆕 (Faz 68, koşulmadı) · 2 🆕 (Faz 89, koşulmadı) · 4 🆕 (Faz 119: MT-OBS-054..057, gerçek `samples/AgentPrism.Api` + sağlayıcı anahtarı gerekir, koşulmadı) — MT-OBS-058 koşuldu (2026-08-27) · 6 🆕 (Faz 132: MT-OBS-059..064, gerçek `samples/AgentPrism.Api` gerekir, koşulmadı) |
