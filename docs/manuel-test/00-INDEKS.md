...
| 18 | [`18-MCP-VE-A2A.md`](18-MCP-VE-A2A.md) | `MCP` | 6, 22, 50, 89, 127 | `src/Tracon.Mcp` · `src/Tracon.AspNetCore/McpServer` · `A2A` · `Endpoints/GovernanceEndpoints.cs` (yalnız `/api/mcp-servers/*`) | **59** | ✅ | ✅ 56/59 · 3 ☐ (`MT-MCP-058` · `067` · `069` — 069 koşulmadı; ➜ CI) |
