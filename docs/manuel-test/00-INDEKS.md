...
| 24 | [`24-TEST-PAKETI-VE-SABLON.md`](24-TEST-PAKETI-VE-SABLON.md) | `TEST` | 37, 39, 95, 98 | `src/AgentPrism.Testing` · `src/AgentPrism.Templates` · `src/AgentPrism.Testing.Contracts.Xunit` · `samples/AgentPrism.Samples.FileRunStore(.Tests)` · `tests/AgentPrism.Package.Tests` | **49** | ✅ | ✅ 44/44 (2026-08-24) · MT-TEST-073..076 Faz 98 kapanışında koşuldu (2026-08-24); 077 👤 gerekir |
