...
| 02 | [`02-CEKIRDEK-VE-KATALOG.md`](02-CEKIRDEK-VE-KATALOG.md) | `CORE` | 1, 3, 72 | `src/AgentPrism.Core` (`Compilation/` · `Catalog/` · `Tools/` · `Sessions/`) · `src/AgentPrism.Abstractions` | **49** | ✅ | ✅ 42/42 (2026-08-13) · MT-CORE-075..080 Faz 72 kapanışında koşuldu, 081 👤 gerekir |
...
| 27 | [`27-MODEL-YEDEK-VE-ON-UCUS.md`](27-MODEL-YEDEK-VE-ON-UCUS.md) | `MYU` | 62 | `src/AgentPrism.Abstractions/Agents/{ModelBinding,ModelFallback}.cs` · `Options/{AgentPrismPreflightOptions,AgentPrismModelConcurrencyOptions}.cs` · `src/AgentPrism.Core/Models/{FallbackChatClient,ProviderConcurrencyLimiter,ContextWindowEstimator,ModelProviderRegistry}.cs` · `Compilation/AgentDefinitionCompiler.cs` (yalnız `BuildContextWindowStrategy`) · `src/AgentPrism.AspNetCore/Endpoints/AgentEndpoints.cs` (yalnız `EstimateAsync`) · `RateLimiting/PreflightGate.cs` | **9** | ✅ | ⬜ henüz koşulmadı |
