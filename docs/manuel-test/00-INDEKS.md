...
| 36 | [`36-GELISTIRME-KAPILARI.md`](36-GELISTIRME-KAPILARI.md) | `GDK` | 91, 92, 116, 167 | `scripts/kapi.py` · `scripts/denetim-paketi.py` · `scripts/*_test.py` · `src/Tracon.UI/Tracon.UI.Frontend.targets` · `docfx/docfx.json` · `DocfxConfigurationTests.cs` · `CanaryEvaluationServiceTests.cs` · `RunReconciliationTests.cs` · `bench/Tracon.Benchmarks/` | **31** | ✅ | ✅ otomatik kapılar koşuldu (19-23, 25 Faz 116 kapanışında); UI Playwright 57/57, browser connector görsel koşumu ve 24 (iki işletim sistemi) 👤 insan gerekir |
