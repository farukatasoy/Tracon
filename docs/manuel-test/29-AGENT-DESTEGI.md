...
flowchart TD
    ...
    PKG --> AN["analyzers/dotnet/cs<br/>APG01xx 02xx 03xx 0401"]
...
Elle yazılmış, işaret taşımayan bir `AGENTS.md` hiçbir zaman bildirilmez —
bunu doğrulamak için dosyayı `# Ev kurallari` ile değiştirip tekrar derleyin.
...
yoktur. `AgentPrism.Tools` ailesi (APG0001–0007) etkilenmez — o tanılar gerçek
derleme hatalarıdır ve bu anahtar onları kapsamaz.
