...
| Kanal | ID'ler | Kural |
|---|---|---|
| **Plana dönüştü** | F-109 → [Faz 112](arsiv/fazlar/112-REPLAY-ISTEMCI-TOOL-SOZLESMESI.md) · F-149 → [Faz 113](arsiv/fazlar/113-ARIZA-SINIFLANDIRMA-SEAMI.md) · F-166 → [Faz 114](arsiv/fazlar/114-CALISTIRMA-ICI-BUTCE-TAVANI.md) · F-168 → [Faz 115](115-EVALIN-BASSIZ-KOSUCUSU.md) · F-67 → [Faz 116](116-PERFORMANS-TAHSIS-KAPISI.md) · F-167 → [Faz 117](117-MCP-TASKS-UZANTISI.md) · F-152 → [Faz 118](118-YARGIC-BASINA-CHECKPOINT.md) | Bölümleri bu dosyadan silindi; kanıt ve tasarım faz dokümanındadır. Aday listesine geri dönmezler. |
