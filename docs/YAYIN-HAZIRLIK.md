...
| BL-041 job sözleşmesi | ✅ Kapandı ([Faz 120](arsiv/fazlar/120-JOB-SOZLESMESI-AT-LEAST-ONCE.md)) — `IJobHandler` sözleşmesi at-least-once'ı yazıyor, `JobHandlerContract` + `JobLeaseExpiryTests` kilitliyor |
