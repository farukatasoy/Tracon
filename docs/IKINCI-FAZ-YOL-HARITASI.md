...
| 23 | [23-SQL-SERVER.md](23-SQL-SERVER.md) | F-06 | ⚠️ **Kod tamam (2026-08-04), doğrulama bekliyor.** Kapsam genişledi: depo uygulamaları da `AgentPrism.Sql.Shared` altında paylaşılıyor (K-176) — PostgreSQL Npgsql'den ADO.NET tabanına taşındı, 416/416 test korundu. SQL Server sözleşme testleri geliştirme makinesinde koşturulamadı (amd64 emülasyonu kapalı) | `AgentPrism.SqlServer` + `AgentPrism.Sql.Shared` (paket değil) | kendi (`0001`) |
| 24 | [24-SQLITE.md](24-SQLITE.md) | F-07 | **Sıradaki.** Faz 23'ün paylaşım modelini üçüncü kez kullanır — modelin asıl kanıtı. Depolara dokunmak gerekiyorsa soyutlama eksiktir | `AgentPrism.Sqlite` | kendi |
| 25 | [25-VERI-SAKLAMA-VE-ARSIVLEME.md](25-VERI-SAKLAMA-VE-ARSIVLEME.md) | F-08 | K-063 (partition) burada kanıtla kapanır | — | 0014 |
