...
| **🆕 Sürüklenmeyi fark eden mekanizma yok** | `.github/` yalnız `ci.yml` taşır; dependabot/renovate yapılandırması yok | ✅ Evet | ⏳ Kullanıcı onayladı |
| MAF 1.16→1.18 · MEAI 10.8.3→10.9.0 · MCP.Core 2.0.0→2.2.0 | `Directory.Packages.props:19,156`; keşif notu 2026-08-20 | ✅ Evet | ⏳ Kullanıcı onayladı |
