...
internal static class ProtectingStoreContext
{
    ...
    /// protector — exactly what <c>AddAgentPrism()</c> registers when the
    ...
    /// <see cref="AgentPrismContentProtectionOptions.Enabled"/> after writing
    /// and see the protector follow it.
    /// </param>
    /// <returns>The protector.</returns>
    public static AesGcmContentProtector CreateProtector(AgentPrismContentProtectionOptions options)
    {
