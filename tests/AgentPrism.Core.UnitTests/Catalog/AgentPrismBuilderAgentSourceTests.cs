...
public sealed class AgentPrismBuilderAgentSourceTests
{
    [Fact]
    public void AddAgentSource_of_T_registers_a_singleton()
    {
        var services = new ServiceCollection();
        services.AddAgentPrism().AddAgentSource<CountingSource>();
    ...
    public void AddAgentSource_by_instance_is_the_same_instance_every_resolve()
    {
        ...
        var services = new ServiceCollection();
        services.AddAgentPrism().AddAgentSource(instance);
        using var provider = services.BuildServiceProvider();
    ...
    public void AddAgentSource_by_factory_runs_the_factory_once_across_repeated_resolves()
    {
        var factoryCalls = 0;
        var services = new ServiceCollection();
        services.AddAgentPrism().AddAgentSource(_ =>
        {
            factoryCalls++;
