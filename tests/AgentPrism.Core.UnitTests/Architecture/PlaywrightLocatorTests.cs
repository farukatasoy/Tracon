...
/// paid down. Refresh:
/// <c>AGENTPRISM_PLAYWRIGHT_LOCATOR_REFRESH=1 dotnet test tests/AgentPrism.Core.UnitTests -c Release</c>.
/// </para>
/// </remarks>
public sealed class PlaywrightLocatorTests
{
    private const string RefreshEnvVar = "AGENTPRISM_PLAYWRIGHT_LOCATOR_REFRESH";
    ...
    private static readonly string[] SkippedFiles =
        ["tests/AgentPrism.Core.UnitTests/Architecture/PlaywrightLocatorTests.cs"];
    ...
    {
        var directory = Directory.CreateTempSubdirectory("agentprism-locator-test");
