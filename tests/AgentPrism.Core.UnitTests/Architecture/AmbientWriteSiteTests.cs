...
/// <c>AGENTPRISM_AMBIENT_WRITE_REFRESH=1 dotnet test tests/AgentPrism.Core.UnitTests -c Release</c>.
/// </para>
/// <para>
...
{
    private const string RefreshEnvVar = "AGENTPRISM_AMBIENT_WRITE_REFRESH";
    ...
    {
        var directory = Directory.CreateTempSubdirectory("agentprism-ambient-write-test");
    ...
    public void Scan_ignores_a_reference_inside_a_doc_comment()
    {
        ...
        try
        {
            File.WriteAllText(
                ...
                public sealed class Widget
                {
                    /// <summary>See <see cref="AgentPrismRunContext.SetCurrent(AgentRunScope)"/>.</summary>
                    private void DoWork()
                    {
                    }
                }
