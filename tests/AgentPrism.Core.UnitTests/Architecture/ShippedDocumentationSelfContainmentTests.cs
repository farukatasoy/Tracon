...
/// <c>AGENTPRISM_SHIPPED_DOCS_REFRESH=1 dotnet test tests/AgentPrism.Core.UnitTests -c Release</c>.
/// </para>
/// <para>
...
{
    private const string RefreshEnvVar = "AGENTPRISM_SHIPPED_DOCS_REFRESH";
    ...
    private static IEnumerable<(string Relative, string Absolute, ScanKind Kind)> EnumerateShippedFiles()
    {
        ...
        {
            yield return ("docs/openapi/agentprism.json", openApi, ScanKind.EveryLine);
        }
    }
