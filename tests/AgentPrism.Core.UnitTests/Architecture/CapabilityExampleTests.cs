...
/// <c>AGENTPRISM_CAPABILITY_EXAMPLE_REFRESH=1 dotnet test tests/AgentPrism.Core.UnitTests -c Release</c>.
/// </para>
/// </remarks>
public sealed class CapabilityExampleTests
{
    private const string RefreshEnvVar = "AGENTPRISM_CAPABILITY_EXAMPLE_REFRESH";
    ...
    /// allowed to show. An AgentPrism member NEVER belongs here — the point of
    ...
    public void Every_registration_entry_point_shows_a_worked_example()
    {
        ...
        unreadable.ShouldBeEmpty(
            customMessage: "No XML documentation was found for these entry points: " +
                           ...
                           "Build the solution first: dotnet build AgentPrism.slnx -c Release");
        ...
        failures.ShouldBeEmpty(
            customMessage: "The public API and its worked examples disagree.\n" +
                           ...
                           $"refresh the baseline: {RefreshEnvVar}=1 dotnet test tests/AgentPrism.Core.UnitTests -c Release");
    }
