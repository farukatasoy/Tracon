...
/// <remarks>
/// <para>
/// The defect this guards (Phase 121, the "35x 🟡 systemic lane"): AgentPrism has 78
...
/// 2026-08-27: only 12 of 76 <c>AgentPrism.Abstractions</c> interfaces mentioned
...
/// <c>AGENTPRISM_SEAM_CONTRACT_REFRESH=1 dotnet test tests/AgentPrism.Core.UnitTests -c Release</c>.
/// </para>
/// <para>
...
{
    private const string RefreshEnvVar = "AGENTPRISM_SEAM_CONTRACT_REFRESH";
    ...
    {
        var directory = Directory.CreateTempSubdirectory("agentprism-seam-contract-test");
    ...
    {
        {
            ...
            Path.Combine("AgentPrism.Abstractions", "Runs", "IRunCancellationRegistry.cs"),
        ...
        },
        {
            ...
            Path.Combine("AgentPrism.Abstractions", "Coordination", "ISingletonLeaseStore.cs"),
        ...
        },
        {
            ...
            Path.Combine("AgentPrism.Abstractions", "Runs", "IAgentPrismDrainState.cs"),
