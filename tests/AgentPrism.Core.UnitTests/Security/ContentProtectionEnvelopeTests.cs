...
public sealed class ContentProtectionEnvelopeTests
{
    ...
    public void TryUnwrap_throws_when_the_envelope_carries_no_key_id()
    {
        ...
        Should.Throw<AgentPrismException>(() => ContentProtectionEnvelope.TryUnwrap(malformed, out _, out _, out _, out _));
    }
    ...
    public void TryUnwrap_throws_when_the_ciphertext_is_shorter_than_the_authentication_tag()
    {
        ...
        Should.Throw<AgentPrismException>(() => ContentProtectionEnvelope.TryUnwrap(envelope, out _, out _, out _, out _));
    }
    ...
    public void WrapBinary_rejects_a_key_id_too_long_for_the_one_byte_header_field()
    {
        ...
        Should.Throw<AgentPrismException>(() => ContentProtectionEnvelope.WrapBinary(tooLong, new byte[12], [], new byte[16]));
    }
}
