...
public sealed class QuotaNoticeOrderingTests
{
    ...
    {
        // Depth is read directly from AgentPrismRunOptions.Depth
    ...
    private sealed class QuotaHarness : IDisposable
    {
        ...
        public QuotaHarness()
        {
            ...
            Enforcer = new QuotaEnforcer(QuotaStore, StaticOptions(new AgentPrismQuotaOptions()));
        }
        ...
        private static StaticOptionsMonitor<AgentPrismQuotaOptions> StaticOptions(AgentPrismQuotaOptions options) => new(options);
