...
/// <summary>
/// Fail-fast validation for <see cref="AgentPrismAgentGraphOptions.ChildDeadline"/>/
/// <see cref="AgentPrismAgentGraphOptions.WaitTimeout"/> — the tree-wide
...
public sealed class AgentGraphWaitLimitValidationTests
{
    ...
    {
        var result = new AgentPrismOptionsValidator().Validate(null, new AgentPrismOptions());
    ...
    public void A_non_positive_ChildDeadline_is_rejected(int seconds)
    {
        ...
        result.Failures!.ShouldContain(
            failure => failure.Contains(nameof(AgentPrismAgentGraphOptions.ChildDeadline), StringComparison.Ordinal));
    }
    ...
    public void A_WaitTimeout_equal_to_ChildDeadline_is_rejected()
    {
        ...
        result.Succeeded.ShouldBeFalse();
        result.Failures!.ShouldContain(
            failure => failure.Contains(nameof(AgentPrismAgentGraphOptions.WaitTimeout), StringComparison.Ordinal));
    }
    ...
    {
        var options = new AgentPrismAgentGraphOptions
        {
    ...
    public void A_ChildDeadline_near_TimeSpanMaxValue_does_not_overflow_the_derived_WaitTimeout()
    {
        ...
        var options = new AgentPrismAgentGraphOptions { ChildDeadline = TimeSpan.MaxValue };
        ...
        var result = new AgentPrismOptionsValidator().Validate(null, new AgentPrismOptions { AgentGraph = options });
