...
public sealed class AgentRunBudgetDurationTests
{
    ...
    public void Zero_or_negative_MaxDuration_removes_the_limit_via_CreateBudget()
    {
        ...
        var zero = new AgentPrismAgentGraphOptions { MaxDuration = TimeSpan.Zero }.CreateBudget(clock);
        var negative = new AgentPrismAgentGraphOptions { MaxDuration = TimeSpan.FromSeconds(-1) }.CreateBudget(clock);
    ...
    public void Positive_MaxDuration_carries_through_CreateBudget()
    {
        ...
        var budget = new AgentPrismAgentGraphOptions { MaxDuration = TimeSpan.FromMinutes(10) }.CreateBudget(clock);
    ...
    {
        // Unlike AgentPrismAgentGraphOptions.CreateBudget (where zero/negative
    ...
    public void DescribeModelCallExhaustion_and_IsExhausted_derive_from_the_SAME_deadline_check()
    {
        ...
        budget.IsExhausted.ShouldBeTrue();
        budget.DescribeModelCallExhaustion().ShouldContain("AgentPrism:AgentGraph:MaxDuration", Case.Sensitive);
    }
}
