...
/// AgentPrism assigned an option and hoped.
/// </remarks>
...
public sealed class LoopCompilationTests
{
    ...
    public void A_criterion_registered_in_code_is_resolvable_from_a_declarative_definition()
    {
        ...
        var compiler = BuildCompiler(new AgentPrismLoopEvaluatorRegistration("hasCitations", custom));
    ...
    private static AgentDefinitionCompiler BuildCompiler(params AgentPrismLoopEvaluatorRegistration[] registrations)
        => new(
