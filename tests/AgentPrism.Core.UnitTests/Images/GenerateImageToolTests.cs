...
/// </summary>
/// <remarks>
/// <see cref="AgentPrism.AspNetCore.FunctionalTests.ImageEndpointTests"/> proves
...
public sealed class GenerateImageToolTests
{
    ...
    public async Task Missing_run_scope_fails_after_generation_but_before_writing_an_attachment()
    {
        ...
        // No AgentPrismRunContext.SetCurrent call: simulates a tool invoked outside a run.
    ...
    {
        public void Dispose() => AgentPrismRunContext.SetCurrent(null);
    }
