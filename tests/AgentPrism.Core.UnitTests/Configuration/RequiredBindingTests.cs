...
public sealed class RequiredBindingTests
{
    ...
    {
        // The lock under the two branches below: for these two points AgentPrism
        ...
        AgentPrismExtensionPoints.Find(typeof(IAttachmentStorage))!.BuiltInDefault.ShouldBeNull();
        AgentPrismExtensionPoints.Find(typeof(IRunEventSink))!.BuiltInDefault.ShouldBeNull();

        AgentPrismExtensionPoints.Find(typeof(IRunEventSink))!.CollectionProbe.ShouldNotBeNull();
        AgentPrismExtensionPoints.Find(typeof(IAttachmentStorage))!.CollectionProbe.ShouldBeNull();
    }
    ...
    public async Task The_message_names_the_contract_the_resolved_type_and_the_fix()
    {
        ...
        exception.Message.ShouldContain("AddAgentPrism()");
