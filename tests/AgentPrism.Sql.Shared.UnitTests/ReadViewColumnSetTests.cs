...
public sealed class ReadViewColumnSetTests
{
    ...
    public void PostgreSql_runs_v1_carries_every_published_column()
        => AssertColumnSet(typeof(PostgresQueries).Assembly, "AgentPrism.PostgreSql.MigrationsViews.");

    [Fact]
    public void SqlServer_runs_v1_carries_every_published_column()
        => AssertColumnSet(typeof(SqlServerQueries).Assembly, "AgentPrism.SqlServer.MigrationsViews.");

    [Fact]
    public void Sqlite_runs_v1_carries_every_published_column()
        => AssertColumnSet(typeof(SqliteQueries).Assembly, "AgentPrism.Sqlite.MigrationsViews.");

    [Fact]
    public void PostgreSql_runs_v1_carries_no_protected_column()
        => AssertNoProtectedColumn(typeof(PostgresQueries).Assembly, "AgentPrism.PostgreSql.MigrationsViews.");

    [Fact]
    public void SqlServer_runs_v1_carries_no_protected_column()
        => AssertNoProtectedColumn(typeof(SqlServerQueries).Assembly, "AgentPrism.SqlServer.MigrationsViews.");

    [Fact]
    public void Sqlite_runs_v1_carries_no_protected_column()
        => AssertNoProtectedColumn(typeof(SqliteQueries).Assembly, "AgentPrism.Sqlite.MigrationsViews.");
