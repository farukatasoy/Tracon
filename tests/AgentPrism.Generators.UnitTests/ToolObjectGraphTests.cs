...
public sealed class ToolObjectGraphTests
{
    ...
    public void A_graph_four_levels_deep_produces_APG0012_and_blocks_generation()
    {
        const string Source = """
            ...
            {
                [AgentPrismTool("walk", "Walks a deep graph.")]
    ...
    public void A_graph_three_levels_deep_is_within_the_limit()
    {
        const string Source = """
            ...
            internal static class Tools
            {
                [AgentPrismTool("walk", "Walks a graph.", JsonSerializerContext = typeof(ToolJsonContext))]
                public static void Walk([Description("The root.")] Level0 root) { }
            }
            """;
    ...
    public async Task A_cycle_produces_APG0012_naming_the_cyclic_path_and_the_generator_returns_promptly()
    {
        const string Source = """
            ...
            internal static class Tools
            {
                [AgentPrismTool("walk", "Walks a cyclic graph.")]
    ...
    public void An_object_parameter_with_no_JsonSerializerContext_reports_APG0011_for_every_type_in_its_graph()
    {
        const string Source = """
            ...
            internal static class Tools
            {
                [AgentPrismTool("process", "Processes an object.")]
    ...
    public void A_JsonSerializerContext_missing_only_a_nested_type_reports_APG0011_for_that_type_alone()
    {
        const string Source = """
            ...
            internal static class Tools
            {
                [AgentPrismTool("process", "Processes an object.", JsonSerializerContext = typeof(ToolJsonContext))]
                public static void Process([Description("The value.")] Outer value) { }
            }
            """;
    ...
    public void A_type_with_more_than_one_public_constructor_is_reported_as_an_unsupported_parameter_type()
    {
        const string Source = """
            ...
            internal static class Tools
            {
                [AgentPrismTool("process", "Processes a value.")]
