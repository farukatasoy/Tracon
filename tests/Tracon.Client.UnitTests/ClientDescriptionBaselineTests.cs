...
/// <remarks>
/// <para>
/// <c>Generated/TraconApiClient.g.cs</c> carries a file-level
...
public sealed class ClientDescriptionBaselineTests
{
    ...
    private static string GeneratedClientPath { get; } =
        Path.Combine(RepositoryRoot, "src", "Tracon.Client", "Generated", "TraconApiClient.g.cs");

    private static string BaselinePath { get; } =
        Path.Combine(RepositoryRoot, "tests", "Tracon.Client.UnitTests", "client-description-baseline.txt");
