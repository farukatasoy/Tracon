...
/// <summary>
/// <c>UsePostgreSql(o =&gt; o.DataSource = ...)</c>: a data source AgentPrism did
...
public sealed class ExternalDataSourceTests(PostgresFixture fixture)
{
    ...
    public async Task DataSource_and_ConnectionString_together_is_rejected()
    {
        ...
        exception.Message.ShouldContain(nameof(AgentPrismPostgreSqlOptions.DataSource));
    ...
    public async Task DataSource_alone_does_not_require_a_connection_string()
    {
        ...
        provider.GetRequiredService<IOptions<AgentPrismPostgreSqlOptions>>().Value.ShouldNotBeNull();
    ...
    /// <summary>Mirror of the above: AgentPrism's OWN data source IS disposed at shutdown.</summary>
    [Fact]
