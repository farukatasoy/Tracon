...
namespace AgentPrism.PostgreSql.IntegrationTests.Load;
...
/// AgentPrism; the two phases below are timed apart so the report can say
...
/// </para>
/// <para>
/// It is <strong>opt-in</strong>: <c>AGENTPRISM_LOAD=1</c>. The run costs tens
...
{
    private const string OptInVariable = "AGENTPRISM_LOAD";
