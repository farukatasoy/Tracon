...
public sealed class ReplayClientToolEndpointTests
{
    ...
    {
        await using var host = await AgentPrismTestHost.StartAsync(ConfigureClientToolAgent);
    ...
    {
        await using var host = await AgentPrismTestHost.StartAsync(ConfigureServerToolAgent);
    ...
    {
        await using var host = await AgentPrismTestHost.StartAsync(ConfigureNoToolAgent);
    ...
    private static void ConfigureClientToolAgent(IAgentPrismBuilder builder)
    {
    ...
    private static void ConfigureServerToolAgent(IAgentPrismBuilder builder)
    {
    ...
    private static void ConfigureNoToolAgent(IAgentPrismBuilder builder)
        => SaveDefinition(builder, new AgentDefinition
        {
            Name = AgentName,
            Instructions = "Give a short answer.",
