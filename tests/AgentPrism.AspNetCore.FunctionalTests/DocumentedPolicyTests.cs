...
public sealed class DocumentedPolicyTests
{
    ...
    {
        [nameof(AgentPrismSessionOwnershipOptions)] = typeof(AgentPrismSessionOwnershipOptions),
        [nameof(AgentPrismRetentionOptions)] = typeof(AgentPrismRetentionOptions),
        [nameof(AgentPrismSqliteOptions)] = typeof(AgentPrismSqliteOptions),
        [nameof(AgentPrismSchedulingOptions)] = typeof(AgentPrismSchedulingOptions),
        [nameof(AgentPrismMcpServerOptions)] = typeof(AgentPrismMcpServerOptions),
        [nameof(AgentPrismEndpointOptions)] = typeof(AgentPrismEndpointOptions),
        [nameof(AgentPrismImageOptions)] = typeof(AgentPrismImageOptions),
        [nameof(AgentPrismEgressOptions)] = typeof(AgentPrismEgressOptions),
    };
    ...
    private static async Task<HttpResponseMessage> SendAsync(AgentPrismTestHost host, string method, string path, string apiKey)
    {
