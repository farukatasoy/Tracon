...
public sealed class VoiceAuthorizationTests
{
    ...
    private static async Task<WebSocket> ConnectAsync(AgentPrismTestHost host, string sessionId)
    {
    ...
    private static async Task SeedSessionAsync(AgentPrismTestHost host, string sessionId)
    {
        var sessions = host.Services.GetRequiredService<ISessionStore>();
