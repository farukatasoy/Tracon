...
public sealed class LiveVoiceRegistrationTests
{
    ...
    public async Task Without_UseLiveVoice_the_route_does_not_exist()
    {
        await using var host = await AgentPrismTestHost.StartAsync(
            configureAgentPrism: static builder => builder.AddAgent(TestData.Definition(Agent)));
    ...
    private static Task<HttpResponseMessage> PostAsync(AgentPrismTestHost host)
