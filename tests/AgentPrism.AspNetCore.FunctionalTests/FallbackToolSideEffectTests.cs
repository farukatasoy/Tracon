...
/// <c>[AgentPrismTool]</c> method that counts how many times its body ran.
/// </remarks>
public sealed class FallbackToolSideEffectTests
{
    ...
    public async Task A_side_effecting_tool_runs_once_even_though_the_fallback_asks_for_it_again()
    {
        ...
        var primary = new StepModelProvider(
            ...
            Step.Throw(new AgentPrismProviderUnavailableException("simulated outage") { ProviderName = "primary-provider" }));
        ...
        await using var host = await AgentPrismTestHost.StartAsync(builder => builder
    ...
    public async Task Falling_back_once_does_not_leave_the_compiled_agents_options_permanently_wrapped()
    {
        ...
        var primary = new StepModelProvider(
            "primary-provider-2",
            Step.CallTool("charge_customer", "orderId", "ORD-1"),
            Step.Throw(new AgentPrismProviderUnavailableException("simulated outage") { ProviderName = "primary-provider-2" }),
    ...
    public async Task Two_concurrent_tool_calls_both_answered_correctly_when_the_fallback_repeats_them()
    {
        ...
        var primary = new StepModelProvider(
            ...
            Step.Throw(new AgentPrismProviderUnavailableException("simulated outage") { ProviderName = "primary-provider-3" }));
...
/// </summary>
/// <remarks>
/// Unlike <see cref="AgentPrism.Testing.FakeModelProvider"/>, a step can
...
file static class ChargeProbeTool
{
    ...
    [AgentPrismTool("charge_customer", "Charges the customer for an order. Not safe to repeat.")]
