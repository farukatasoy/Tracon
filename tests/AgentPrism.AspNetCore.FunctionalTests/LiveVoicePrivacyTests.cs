...
/// <remarks>
/// <para>
/// The audio of a live session never reaches AgentPrism, so nothing can store it.
...
public sealed class LiveVoicePrivacyTests
{
    ...
    private static Task<HttpResponseMessage> CreateAsync(AgentPrismTestHost host)
