...
/// <summary>
/// Tests for cross-origin access to the AgentPrism endpoints
/// (<see cref="AgentPrismEndpointOptions.AllowedOrigins"/>, Phase 61).
/// </summary>
/// <remarks>
...
public sealed class CorsOptionsTests
{
    ...
    [Fact]
    public async Task Cors_does_not_affect_a_request_outside_the_AgentPrism_prefix()
    {
        await using var host = await AgentPrismTestHost.StartAsync(
            configureEndpoints: static options => options.AllowedOrigins.Add(AllowedOrigin),
