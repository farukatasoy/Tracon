...
/// <summary>
/// Verifies that the committed <c>docs/openapi/tracon.json</c> file stays
...
/// To refresh the file:
/// <c>TRACON_OPENAPI_REFRESH=1 dotnet test tests/Tracon.AspNetCore.FunctionalTests
/// -c Release --filter FullyQualifiedName~OpenApiSnapshotTests</c>.
/// </remarks>
public sealed class OpenApiSnapshotTests
{
    private const string RefreshEnvVar = "TRACON_OPENAPI_REFRESH";
    ...
    private static string DescribeDifference(string current, string committed)
    {
        ...
        return "The OpenAPI document differs from 'docs/openapi/tracon.json' at character " +
               ...
               $"To refresh: {RefreshEnvVar}=1 dotnet test tests/Tracon.AspNetCore.FunctionalTests " +
