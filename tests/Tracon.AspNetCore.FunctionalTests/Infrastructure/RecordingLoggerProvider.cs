...
/// <summary>
/// A logger provider that collects every written log line in memory.
/// Secret-leak tests inspect what was written to the log through this.
/// </summary>
internal sealed class RecordingLoggerProvider : ILoggerProvider
{
    ...
    public void Dispose()
    {
        // Collected lines live for the duration of the test; there is nothing to release.
    }
