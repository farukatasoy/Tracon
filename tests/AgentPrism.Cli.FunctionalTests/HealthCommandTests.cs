...
public sealed class HealthCommandTests
{
    ...
    [Fact]
    public async Task Reads_health_through_a_custom_MapAgentPrism_prefix()
    {
        ...
        // other than the default "/agentprism". This proves the stripped
        // prefix moved to AgentPrismClientOptions.BaseAddress correctly.
    ...
    public async Task A_server_that_is_not_running_fails_fast_instead_of_hanging()
    {
        ...
        var result = await CliRunner.RunAsync("health", "--url", "http://127.0.0.1:1/agentprism/");
