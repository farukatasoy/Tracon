...
/// <summary>
/// A logger provider that collects all written log lines in memory.
/// Secret-leak tests check what was written to the log through this.
/// </summary>
internal sealed class RecordingLoggerProvider : ILoggerProvider
{
    ...
    public void Dispose()
    {
        // Collected lines persist for the duration of the test; there is no resource to release.
    }
