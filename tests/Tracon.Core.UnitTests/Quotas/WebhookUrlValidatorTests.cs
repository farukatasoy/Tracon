...
{
    private static readonly TraconWebhookOptions Strict = new();

    /// <summary>The shared egress settings at their default: private network closed.</summary>
    private static readonly TraconEgressOptions ClosedEgress = new();
    ...
    {
        var permissive = new TraconWebhookOptions { AllowInsecureHttp = true };
    ...
    {
        var permissive = new TraconWebhookOptions { AllowPrivateNetworkTargets = true };
    ...
    public async Task Loopback_target_can_be_delivered_when_AllowInsecureHttp_is_enabled()
    {
        ...
        var localDev = new TraconWebhookOptions { AllowInsecureHttp = true };
