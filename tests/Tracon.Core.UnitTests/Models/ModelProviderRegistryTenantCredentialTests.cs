...
public sealed class ModelProviderRegistryTenantCredentialTests
{
    ...
    public async Task Tenant_with_a_resolvable_binding_gets_its_own_credential()
    {
        ...
        var registry = CreateRegistry(
            ...
            bindings,
            configuration: BuildConfiguration(("Tracon:ProviderKeys:Acme:OpenAI", "sk-tenant-key")));
    ...
    public async Task Tenant_binding_for_provider_without_credential_capability_fails_closed_before_provider_invocation()
    {
        ...
        await bindings.UpsertAsync(new TenantProviderBinding
        {
            ...
            ApiKeyConfigurationName = "Tracon:ProviderKeys:Acme:OnPremise",
            UpdatedAt = DateTimeOffset.UtcNow,
        });
        ...
        var registry = new ModelProviderRegistry(
            ...
            tenantEgressPolicies: new InMemoryTenantEgressPolicyStore(),
            credentialResolver: CreateResolver(
                BuildConfiguration(("Tracon:ProviderKeys:Acme:OnPremise", "tenant-private-value"))));
    ...
    public async Task A_binding_that_exists_but_resolves_to_no_value_does_not_fall_back_silently()
    {
        ...
        exception.Message.ShouldContain("Tracon:ProviderKeys:Acme:OpenAI");
    ...
    public async Task A_triggered_fallback_resolves_its_own_tenant_credential_through_the_async_entry_point()
    {
        ...
        var primary = new FakeModelProvider(
            new FakeChatClient(_ => throw new TraconProviderUnavailableException("circuit open")),
            name: "openai");
        ...
        await bindings.UpsertAsync(new TenantProviderBinding
        {
            ...
            ApiKeyConfigurationName = "Tracon:ProviderKeys:Acme:Anthropic",
            UpdatedAt = DateTimeOffset.UtcNow,
        });
        ...
        var registry = new ModelProviderRegistry(
            ...
            tenantProviderBindings: bindings,
            tenantEgressPolicies: new InMemoryTenantEgressPolicyStore(),
            credentialResolver: CreateResolver(BuildConfiguration(("Tracon:ProviderKeys:Acme:Anthropic", "sk-fallback-key"))));
