...
public sealed class KnowledgeIngestionServiceTests
{
    ...
    [Fact]
    public async Task Every_method_throws_TraconException_when_not_supported()
    {
    ...
    private static KnowledgeIngestionService CreateService(bool withStore, bool withEmbeddings)
        => new(
            ...
            Options.Create(new TraconKnowledgeOptions { Dimensions = 3 }),
    ...
    private static KnowledgeIngestionService CreateService(
        ...
        => new(
            ...
            Options.Create(new TraconKnowledgeOptions
            {
                Dimensions = 3,
                ChunkSize = chunkSize,
