...
public sealed class RunAuthorizationCoverageTests
{
    ...
    [
        ("src/Tracon.AspNetCore/Endpoints/AgentEndpoints.cs", StartMarker, 1),
        ("src/Tracon.AspNetCore/Endpoints/WorkflowEndpoints.cs", StartMarker, 1),
        ("src/Tracon.AspNetCore/Endpoints/WorkflowEndpoints.cs", ResourceStartMarker, 2),
        ("src/Tracon.AspNetCore/Endpoints/TriggerEndpoints.cs", StartMarker, 1),
        ("src/Tracon.AspNetCore/OpenAICompat/OpenAIResponsesEndpoints.cs", StartMarker, 1),
        ("src/Tracon.AspNetCore/OpenAICompat/OpenAIChatCompletionsEndpoints.cs", StartMarker, 1),
        ("src/Tracon.AspNetCore/Endpoints/RunEndpoints.cs", ResourceStartMarker, 1),
    ];
    ...
    /// miss, found twice. Phase 148 gave it Tracon's own ownership
    ...
    [
        ("src/Tracon.AspNetCore/Endpoints/RunEndpoints.cs", ResourceMarker, 12),
        ("src/Tracon.AspNetCore/Endpoints/ObservabilityEndpoints.cs", ResourceMarker, 2),
        ("src/Tracon.AspNetCore/Endpoints/AttachmentEndpoints.cs", ResourceMarker, 4),
        ("src/Tracon.AspNetCore/Endpoints/ApprovalEndpoints.cs", ResourceMarker, 3),
        ("src/Tracon.AspNetCore/Endpoints/SessionEndpoints.cs", ResourceMarker, 4),
        ("src/Tracon.AspNetCore/Endpoints/WorkflowEndpoints.cs", ResourceMarker, 2),
        ("src/Tracon.AspNetCore/Endpoints/EvalEndpoints.cs", ResourceMarker, 2),
        ...
        ("src/Tracon.AspNetCore/Voice/VoiceEndpointGates.cs", ResourceMarker, 1),
        ("src/Tracon.AspNetCore/OpenAICompat/OpenAIConversationsEndpoints.cs", ResourceMarker, 3),
    ];
    ...
    [
        ("src/Tracon.AspNetCore/Endpoints/AgentEndpoints.cs", OwnershipRunMarker, 1),
        ("src/Tracon.AspNetCore/Endpoints/WorkflowEndpoints.cs", OwnershipRunMarker, 1),
        ("src/Tracon.AspNetCore/OpenAICompat/OpenAIResponsesEndpoints.cs", OwnershipRunMarker, 1),
        ("src/Tracon.AspNetCore/Endpoints/SessionEndpoints.cs", OwnershipResourceMarker, 4),
        ("src/Tracon.AspNetCore/Voice/VoiceEndpointGates.cs", OwnershipResourceMarker, 1),
        ("src/Tracon.AspNetCore/OpenAICompat/OpenAIConversationsEndpoints.cs", OwnershipResourceMarker, 3),
    ];
    ...
    {
        var directory = Directory.CreateTempSubdirectory("tracon-run-auth-coverage-test");
