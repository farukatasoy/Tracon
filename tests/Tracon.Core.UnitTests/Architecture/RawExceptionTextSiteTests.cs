...
/// caught, non-<see cref="TraconException"/> exception's own text toward a
...
/// reviewed change:
/// <c>TRACON_RAW_EXCEPTION_TEXT_REFRESH=1 dotnet test tests/Tracon.Core.UnitTests -c Release</c>.
/// </para>
/// <para>
...
/// vakas had. A <c>catch</c> naming a specific, non-<see cref="TraconException"/>
...
{
    private const string RefreshEnvVar = "TRACON_RAW_EXCEPTION_TEXT_REFRESH";
    ...
    {
        var directory = Directory.CreateTempSubdirectory("tracon-raw-exception-text-test");
