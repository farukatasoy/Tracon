...
/// <c>instrument.Meter.Name == "Tracon"</c> therefore also receives
...
/// <c>JobMetricEndToEndTests</c> caught a <c>tracon.job.executions</c>
...
/// (<c>TraconMetrics</c>, <c>QuotaUsageObserver</c>,
/// <c>JobQueueDepthObserver</c>), and <c>TraconTestHost.StartAsync</c>
...
public sealed class MeterListenerIsolationTests
{
    ...
    private static readonly string[] SkippedFiles =
        ["tests/Tracon.Core.UnitTests/Architecture/MeterListenerIsolationTests.cs"];
    ...
    public void No_test_filters_a_MeterListener_by_meter_name()
    {
        ...
        offenders.ShouldBeEmpty(
            ...
            "Tracon.Core.UnitTests/Fakes/MetricTestHelpers.cs) and filter with " +
    ...
    {
        var directory = Directory.CreateTempSubdirectory("tracon-meter-test");
