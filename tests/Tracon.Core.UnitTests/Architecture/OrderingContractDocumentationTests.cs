    ...
    {
        {
            ...
            Path.Combine("Tracon.Abstractions", "Agents", "IAgentDecorator.cs"),
            "int Order { get; }",
        ...
        },
        {
            ...
            Path.Combine("Tracon.Abstractions", "Agents", "IAgentSource.cs"),
            "int Priority { get; }",
        ...
        },
        {
            ...
            Path.Combine("Tracon.Abstractions", "Agents", "IAgentCatalog.cs"),
            "ValueTask<IReadOnlyList<AgentDescriptor>> ListAsync",
            ["lower value wins"]
        },
        {
            // BL-008 (phase 122): the example used to register AFTER
            // AddTracon(), contradicting the "registered before wins"
            ...
            // order flipped back.
            Path.Combine("Tracon.Core", "ITraconBuilder.cs"),
            "IServiceCollection Services { get; }",
            ["addsingleton(new ordergateway()); builder.addtracon();"]
        },
    };
