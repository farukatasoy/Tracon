...
public sealed class ToolRegistrationTests
{
    ...
    public void Direct_delegate_and_scanned_registration_paths_preserve_all_metadata()
    {
        ...
        var registrations = provider.GetServices<TraconToolRegistration>().ToArray();
    ...
    public void AddToolsFrom_throws_when_there_is_no_marked_method()
    {
        ...
        exception.Message.ShouldContain("TraconTool");
    }
    ...
    public void AddToolsFrom_rejects_the_sample_method_at_scan_time()
    {
        ...
        var exception = Should.Throw<TraconException>(
            () => services.AddTracon().AddToolsFrom<SampleClassWithMethod>());
    ...
    private static IToolRegistry BuildRegistry(Action<ITraconBuilder> configure)
    {
        var services = new ServiceCollection();
    ...
    private static class SampleToolClass
    {
        ...
        [TraconTool("custom_name", "Custom-named tool.", RequiresApproval = true)]
