...
internal static class TestData
{
    ...
    public static ToolRegistry Registry(params AIFunction[] tools)
        => new(
            tools.Select(static tool => new TraconToolRegistration(tool)),
    ...
    /// <summary>An <see cref="IOptionsMonitor{TOptions}"/> carrying default <see cref="TraconOptions"/>.</summary>
    public static IOptionsMonitor<TraconOptions> DefaultOptionsMonitor()
    {
        var services = new ServiceCollection();
        services.AddOptions<TraconOptions>();
    ...
    public static ContentGuardPipeline ContentGuards(
        ...
        TraconContentGuardOptions? options = null,
        params IContentGuard[] guards)
        => new(
            guards,
            new StaticOptionsMonitor<TraconContentGuardOptions>(options ?? new TraconContentGuardOptions()),
            auditLog ?? new InMemoryAuditLog(),
            new AmbientAuditActorResolver(Options.Create(new TraconOptions())),
