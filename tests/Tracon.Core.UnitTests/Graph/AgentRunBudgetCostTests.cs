...
public sealed class AgentRunBudgetCostTests
{
    ...
    {
        var budget = new TraconAgentGraphOptions { MaxTotalCost = 0m }.CreateBudget(TimeProvider.System);
    ...
    {
        var budget = new TraconAgentGraphOptions { MaxTotalCost = 12.5m }.CreateBudget(TimeProvider.System);
