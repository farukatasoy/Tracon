...
namespace AgentPrism.Embedded.Tests.Infrastructure;

/// <summary>
/// Runs the ACTUAL <c>samples/AgentPrism.Embedded</c> entry point on
/// <c>WebApplicationFactory</c>'s in-memory <c>TestServer</c>, with the remote
/// address simulated as loopback.
/// </summary>
/// <remarks>
/// <c>MapAgentPrism</c>'s three-layer guard checks
/// <c>HttpContext.Connection.RemoteIpAddress</c>, which the in-memory transport
/// never sets — the same gap
/// <c>tests/AgentPrism.AspNetCore.FunctionalTests/Infrastructure/AgentPrismTestHost.cs</c>
