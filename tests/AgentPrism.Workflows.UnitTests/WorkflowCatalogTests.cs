...
/// with a normalized <see cref="AgentPrismException"/>.
/// </summary>
public sealed class WorkflowCatalogTests
{
    [Fact]
    public void Duplicate_code_workflow_names_throw_an_AgentPrismException()
    {
        ...
        var exception = Should.Throw<AgentPrismException>(() => host.CreateRunner(codeWorkflows: [first, second]));
