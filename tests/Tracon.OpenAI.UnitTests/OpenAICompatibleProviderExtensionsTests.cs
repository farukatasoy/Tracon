...
public sealed class OpenAICompatibleProviderExtensionsTests
{
    ...
    public void Named_provider_without_an_endpoint_fails_validation()
    {
        ...
        services.AddTracon().UseOpenAICompatible("openrouter", static _ => { });
    ...
    public void Options_are_read_from_configuration()
    {
        ...
        var services = new ServiceCollection();
        services.AddTracon().UseOpenAICompatible("openrouter", configuration);
    ...
    {
        var services = new ServiceCollection();
        services.AddTracon().UseOpenAICompatible(name, configure);
