...
public abstract class AuditLogContract : TenantIsolationContract<IAuditLog>
{
    ...
    /// <summary>
    /// Formats an id for embedding in raw SQL. SQLite stores a <see cref="Guid"/> as
    /// UPPERCASE text (K-191) and compares case-sensitively; the default (lowercase
    /// <see cref="Guid.ToString()"/>) is overridden there.
    /// </summary>
