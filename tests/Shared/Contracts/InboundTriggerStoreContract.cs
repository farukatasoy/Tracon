...
/// <summary>Behavior tests for the <see cref="IInboundTriggerStore"/> contract (phase 66).</summary>
/// <remarks>
/// 🚨 This contract never asserts a signing secret VALUE: the store carries
/// only the configuration key's NAME (K-059). It exists to prove tenant
...
public abstract class InboundTriggerStoreContract : TenantIsolationContract<IInboundTriggerStore>
{
    ...
    public async Task Saved_trigger_is_read_back()
    {
        ...
        trigger.SigningSecretConfigurationName.ShouldBe("AgentPrism:TriggerSecrets:Test:Slack");
    ...
    private static InboundTrigger Trigger(string tenantId, string name)
    {
        ...
        return new InboundTrigger
        {
            ...
            TargetName = "demo",
            SigningSecretConfigurationName = "AgentPrism:TriggerSecrets:Test:Slack",
