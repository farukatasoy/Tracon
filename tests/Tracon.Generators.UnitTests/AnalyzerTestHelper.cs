...
/// <summary>
/// Test helper that runs <see cref="TraconUsageAnalyzer"/> against a
...
internal static class AnalyzerTestHelper
{
    ...
    public static readonly (string Key, string Value)[] LocalReferenceOn =
        [("build_property.TraconWriteLocalReference", "true")];
        ...
        (string Key, string Value)[]? properties = null)
    {
        ...
        var withAnalyzers = compilation.WithAnalyzers(
            ImmutableArray.Create<DiagnosticAnalyzer>(new TraconUsageAnalyzer()),
            options);
