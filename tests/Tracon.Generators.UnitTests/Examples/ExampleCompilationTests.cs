...
public sealed class ExampleCompilationTests
{
    ...
    public void Every_package_carrying_an_example_is_referenced_by_this_project()
    {
        ...
        var referencedPackages = Directory.GetFiles(AppContext.BaseDirectory, "Tracon.*.dll")
        ...
        missing.ShouldBeEmpty(
            $"These packages carry an <example> but are not referenced by Tracon.Generators.UnitTests, " +
