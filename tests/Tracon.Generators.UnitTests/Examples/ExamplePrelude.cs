...
/// </para>
/// <para>
/// One block IS a type declaration (a worked <c>[TraconTool]</c> class), not
...
internal static class ExamplePrelude
{
    ...
    [
        ...
        ("ITraconBuilder", "tracon", "null!"),
        ("string", "apiKey", "\"api-key\""),
        ("string", "connectionString", "\"Data Source=tracon.db\""),
    ...
    public static string Wrap(string code)
    {
        ...
        // AddToolsFrom<OrderTools>() and the [TraconTool] example both name
