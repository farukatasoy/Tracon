...
public sealed class GeneratedOutputTests
{
    ...
    public void The_approval_requirement_carries_into_the_generated_registration()
    {
        const string Source = """
            ...
            internal static class Tools
            {
                [TraconTool("delete", "Deletes permanently.", RequiresApproval = true)]
    ...
    public void Undeclared_effect_permission_and_timeout_generate_defaults()
    {
        const string Source = """
            ...
            internal static class Tools
            {
                [TraconTool("get_order_status", "Returns the order status.")]
    ...
    public void An_enum_parameter_generates_a_string_schema_and_Enum_Parse()
    {
        const string Source = """
            ...
            internal static class Tools
            {
                [TraconTool("set_status", "Sets the status.")]
    ...
    public void A_bare_array_parameter_is_converted_with_ToArray_and_the_generated_code_compiles()
    {
        ...
        const string Source = """
            ...
            internal static class Tools
            {
                ...
                [TraconTool("sum_numbers", "Sums numbers.")]
                public static int SumNumbers(int[] numbers) { var sum = 0; foreach (var n in numbers) { sum += n; } return sum; }

                [TraconTool("list_also_works", "IReadOnlyList<T> should still use GetArray directly.")]
        ...
        wrapper.ShouldContain("global::System.Linq.Enumerable.ToArray(global::Tracon.TraconGeneratedToolArguments.GetArray(");
