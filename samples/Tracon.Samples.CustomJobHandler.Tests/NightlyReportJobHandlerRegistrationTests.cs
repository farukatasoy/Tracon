...
namespace Tracon.Samples.CustomJobHandler.Tests;
...
/// registered first, and so this sample — Tracon's own documented example
...
public sealed class NightlyReportJobHandlerRegistrationTests
{
    ...
    public async Task Registration_order_does_not_change_the_outcome()
    {
        ...
        // BEFORE AddTracon(). Under the old enum dispatch these two orders
