using AgentPrism;
using AgentPrism.Samples.CustomAgentSource;
using AgentPrism.Samples.CustomModelProvider;
using AgentPrism.Samples.CustomTool;
using Microsoft.Extensions.AI;
using Microsoft.Extensions.DependencyInjection;

var directory = Directory.CreateTempSubdirectory("agentprism-extension-aot-");
...
var tool = provider.GetServices<AgentPrismToolRegistration>()
