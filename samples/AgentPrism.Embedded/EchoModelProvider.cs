...
/// <c>samples/AgentPrism.Api</c> uses, extended here with one scripted tool
/// call so a real run exercises <c>AgentPrismRunContext.Current</c>: on its
...
internal sealed class EchoModelProvider : IModelProvider
{
    ...
    private sealed class EchoChatClient(string modelId) : IChatClient
    {
        ...
        /// body actually ran, with <c>AgentPrismRunContext.Current</c>
