...
public sealed class JsonFileAgentSourceRunTests
{
    ...
    {
        var directory = Directory.CreateTempSubdirectory("agentprism-json-source-run-").FullName;
        ...
        // AgentPrism-managed service, and the container builds the source itself.
    ...
    {
        var directory = Directory.CreateTempSubdirectory("agentprism-json-source-run-empty-").FullName;
        ...
        agentPrism.AddAgentSource(sp => new JsonFileAgentSource(
