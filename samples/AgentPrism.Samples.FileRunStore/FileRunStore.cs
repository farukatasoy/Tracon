...
/// <c>AgentPrism.Abstractions</c> package -- no reference to
/// <c>AgentPrism.Core</c> or any AgentPrism SQL package.
/// </summary>
/// <remarks>
/// <para>
...
/// <c>AgentPrism.Testing.Contracts.Xunit</c>'s <c>RunStoreContract</c> (and
/// every other applicable contract) in
/// <c>AgentPrism.Samples.FileRunStore.Tests</c>, restored from a local NuGet
