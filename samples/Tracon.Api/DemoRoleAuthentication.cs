...
/// <see cref="TraconPolicies"/> to a real identity provider (OpenID Connect,
/// JWT bearer, Windows authentication) instead.
/// </para>
/// <para>
/// It exists for one reason: without an identity source no
/// <c>RequireRole(...)</c> call in Tracon can be OBSERVED in this reference
...
/// only with <c>Tracon:Demo:Roles:Enabled</c>.
/// </para>
/// </remarks>
internal sealed class DemoRoleAuthenticationHandler : AuthenticationHandler<AuthenticationSchemeOptions>
{
    ...
    public const string SchemeName = "TraconDemoRole";

    /// <summary>The header that carries the role.</summary>
    public const string RoleHeader = "X-Tracon-Demo-Role";
