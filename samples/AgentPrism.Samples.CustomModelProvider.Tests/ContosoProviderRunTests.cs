using AgentPrism.Samples.CustomModelProvider;
using Microsoft.Extensions.DependencyInjection;

namespace AgentPrism.Samples.CustomModelProvider.Tests;

/// <summary>
/// Completes a real agent run through the sample provider, using only
/// published AgentPrism packages.
/// </summary>
/// <remarks>
/// <para>
...
public sealed class ContosoProviderRunTests
{
    ...
    private static ServiceProvider BuildHost(Action<IAgentPrismBuilder>? extra = null)
    {
        var services = new ServiceCollection();

        var agentPrism = services
            .AddAgentPrism()
