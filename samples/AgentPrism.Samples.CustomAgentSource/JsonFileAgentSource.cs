...
/// AgentPrism.Core package alone. Every <see cref="AgentDefinition"/> lives as one
/// JSON file in a directory — standing in for a Git repository, an object store, or
/// any other place a real third party keeps definitions outside AgentPrism's own
/// database.
/// </summary>
/// <remarks>
/// <para>
...
/// sample's test project runs AgentPrism's official <c>AgentSourceContract</c> suite
/// against it.
/// </para>
/// <para>
...
public sealed class JsonFileAgentSource : IAgentSource
{
    ...
    /// by a database — like AgentPrism's own — does not need this: the row it reads
