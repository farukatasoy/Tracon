...
/// <param name="BuiltIn">
/// Whether Tracon itself registered this handler. Only a built-in
        ...
        foreach (var registration in registrations)
        {
            ...
            if (!registration.BuiltIn && JobHandlerKeys.IsReserved(registration.HandlerKey))
            {
                throw new InvalidOperationException(
                    ...
                    $"'{JobHandlerKeys.ReservedPrefix}' namespace belongs to Tracon's own handlers. " +
