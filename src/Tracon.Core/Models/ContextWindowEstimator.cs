...
internal sealed class ContextWindowEstimator
{
    ...
    /// <param name="optionsMonitor">The runtime settings, for <see cref="TraconPreflightOptions.ReserveRatio"/>.</param>
    /// <exception cref="ArgumentNullException">A dependency is <see langword="null"/>.</exception>
    public ContextWindowEstimator(IModelProviderRegistry registry, IOptionsMonitor<TraconOptions> optionsMonitor)
    {
