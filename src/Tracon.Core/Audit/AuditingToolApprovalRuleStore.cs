...
internal sealed class AuditingToolApprovalRuleStore : IToolApprovalRuleStore, IAuditDecorated
{
    ...
    private static string Serialize(ToolApprovalRule rule)
        => JsonSerializer.Serialize(rule, TraconCoreJsonContext.Default.ToolApprovalRule);
}
