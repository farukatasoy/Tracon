...
/// <summary>Converts Tracon skill definitions to an MAF skill source.</summary>
internal sealed class TraconSkillsSource : AgentSkillsSource
{
    /// <summary>
    ...
    {
        TypeInfoResolver = TraconSkillsJsonContext.Default,
    };
