...
/// that <see cref="TraconSkillsSource"/> supplies to MAF for skill and script registration.
...
/// in <c>AgentInlineSkill.AddScript</c> uses that signature. <see cref="TraconSkillsSource.MarshalArguments"/>
/// also carries <see cref="JsonElement"/>.
/// </summary>
[JsonSerializable(typeof(string))]
[JsonSerializable(typeof(JsonElement))]
[JsonSerializable(typeof(object))]
internal sealed partial class TraconSkillsJsonContext : JsonSerializerContext;
