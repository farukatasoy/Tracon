...
/// throws <see cref="TraconException"/>; it does not silently return an
/// empty result.
/// </para>
/// </remarks>
internal sealed partial class KnowledgeIngestionService
{
    ...
    private readonly TraconKnowledgeOptions _options;
    ...
    public KnowledgeIngestionService(
        ...
        IOptions<TraconKnowledgeOptions> options,
    ...
    /// <see cref="TraconKnowledgeOptions.ChunkSize"/> and
    /// <see cref="TraconKnowledgeOptions.ChunkOverlap"/>, and each chunk is
    ...
    /// <exception cref="TraconException"><see cref="IsSupported"/> is <see langword="false"/>.</exception>
    ...
    /// <param name="top">How many results to return. If not given, <see cref="TraconKnowledgeOptions.MaxResults"/>.</param>
    /// <param name="cancellationToken">The cancellation token.</param>
