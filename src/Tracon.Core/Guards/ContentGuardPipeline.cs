...
internal sealed class ContentGuardPipeline
{
    ...
    private readonly IOptionsMonitor<TraconContentGuardOptions> _options;
    ...
    public TraconContentGuardOptions Options => _options.CurrentValue;
    ...
    /// </returns>
    /// <exception cref="TraconContentBlockedException">
        ...
        foreach (var guard in _guards)
        {
            ...
            switch (result.Action)
            {
                case ContentGuardAction.Block:
                    ...
                    throw new TraconContentBlockedException(
    ...
    /// text and was unconditionally replaced. This is Tracon's own
    ...
    /// <remarks>
    /// Formatted by hand: <c>Tracon.Core</c> is AOT-compatible, and opening a
