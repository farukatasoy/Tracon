...
/// where automatic continuation (<see cref="TraconRunContinuationOptions"/>)
...
internal sealed class RunReconciliationService(
    ...
    IOptionsMonitor<TraconRunContinuationOptions> continuationOptionsMonitor,
    ...
    ILogger<RunReconciliationService>? logger = null) : BackgroundService
{
    ...
    /// <see cref="TraconRunContinuationOptions.MaxAttempts"/>, then
