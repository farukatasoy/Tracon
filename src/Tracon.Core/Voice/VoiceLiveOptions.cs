...
/// type configures the conversation Tracon runs itself: utterance buffering,
/// audio format, per-turn speech budget. None of that applies here, because the
/// media never reaches Tracon. The two layers are independent and can be
...
public sealed class VoiceLiveOptions
{
    ...
    /// Tracon starts — a denial-of-service axis that points into the consumer's
    /// own model spend.
    /// </remarks>
