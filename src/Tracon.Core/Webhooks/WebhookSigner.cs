...
/// timestamp is within its own tolerance. Tracon cannot enforce this; it
...
public static class WebhookSigner
{
    ...
    public const string EventHeader = "X-Tracon-Event";

    /// <summary>The header that carries the delivery identity. Used to distinguish duplicate deliveries.</summary>
    public const string DeliveryHeader = "X-Tracon-Delivery";

    /// <summary>The header that carries the timestamp, in Unix seconds.</summary>
    public const string TimestampHeader = "X-Tracon-Timestamp";

    /// <summary>The header that carries the signature.</summary>
    public const string SignatureHeader = "X-Tracon-Signature";

    /// <summary>Reports whether a header name is one Tracon sets itself.</summary>
