...
/// <remarks>
/// <para>
/// Read from the <c>Tracon:Retention</c> configuration section. This class
...
/// </para>
/// </remarks>
public sealed class TraconRetentionOptions
{
    /// <summary>Gets the configuration section name.</summary>
    public const string SectionName = "Tracon:Retention";
