...
/// Use <c>Tracon.PostgreSql</c> in production.
/// </para>
/// </remarks>
internal sealed partial class InMemoryRunStore : IRunStore
{
    ...
    /// registered by <c>AddTracon()</c>, so scores written by the HTTP
    ...
    /// <exception cref="TraconException">The tenant does not match.</exception>
