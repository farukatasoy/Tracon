...
{
    /// <summary>Gomulu migration kaynaklarinin ad oneki.</summary>
    private const string ResourcePrefix = "AgentPrism.PostgreSql.Migrations.";
    ...
    /// </exception>
    public static IReadOnlyList<MigrationDescriptor> Discover(Assembly assembly)
    {
