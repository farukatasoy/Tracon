...
-- duration of audio AgentPrism transcribed itself; `live_seconds` is how long a
-- provider hosted a live session, as reported BY THAT PROVIDER. AgentPrism does not
