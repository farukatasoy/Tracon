...
UPDATE {schema}.jobs SET handler_key = CASE kind
    WHEN 0 THEN N''agentprism.agent-batch''
    WHEN 1 THEN N''agentprism.workflow''
    WHEN 2 THEN N''agentprism.eval''
    WHEN 3 THEN N''agentprism.webhook-delivery''
    WHEN 4 THEN N''agentprism.retention''
    WHEN 5 THEN N''agentprism.agent-run''
    WHEN 6 THEN N''agentprism.online-eval''
    WHEN 7 THEN N''agentprism.approval-resume''
    WHEN 8 THEN N''agentprism.run-continuation''
END
