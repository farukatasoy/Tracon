...
/// <summary>
/// The AgentPrism schema generation each kind of persisted state is written
/// with by THIS build.
/// </summary>
/// <remarks>
/// <para>
/// A generation advances only when AgentPrism changes how it structures the
...
internal static class StateSchemaGenerations
{
    ...
    /// <summary>The generation <c>AgentPrismCheckpointStore</c> stamps onto every checkpoint it writes.</summary>
