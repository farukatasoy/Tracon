...
/// <remarks>
/// <para>
/// An <see cref="AgentPrismException"/> is ours: its message is part of the
/// contract (<see cref="AgentPrismException.ErrorType"/> is a stable code), and is
...
/// endpoint) put there without AgentPrism's control. The safe text carries only
...
public static class SafeErrorText
{
    ...
    public static string ForPersistence(Exception exception, string correlationId)
    {
        ...
        return exception is AgentPrismException
            ? exception.Message
