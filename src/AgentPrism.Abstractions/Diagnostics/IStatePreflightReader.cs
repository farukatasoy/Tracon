...
/// <c>StatePreflight</c> in <c>AgentPrism.Core</c>, the only layer that knows
...
{
    /// <summary>
    /// The stored AgentPrism schema generation, or <see langword="null"/> for
...
public sealed record StateSample
{
    ...
    /// <summary>The stored AgentPrism schema generation, or <see langword="null"/> if never stamped.</summary>
    public required int? SchemaGeneration { get; init; }
