...
/// <c>AgentPrismAgentGraphOptions.ChildDeadline</c> and
/// <c>AgentPrismAgentGraphOptions.WaitTimeout</c>. An invalid combination
/// (zero, negative, or <see cref="WaitTimeout"/> not greater than
/// <see cref="ChildDeadline"/>) is rejected while the agent is built, with
/// <see cref="AgentPrismCompilationException"/>; it is not ignored silently.
/// </para>
/// </remarks>
/// <example>
