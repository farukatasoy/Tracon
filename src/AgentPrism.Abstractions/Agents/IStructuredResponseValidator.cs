...
/// requested schema. AgentPrism checks well-formedness on its own (non-empty,
...
/// today's behaviour exactly, and <c>AgentPrismStructuredResponseOptions.Enabled</c>
/// stays <see langword="false"/> by default on top of that. A consumer replaces
/// the registration to enforce its own rule; AgentPrism does not ship a built-in
...
/// queued or retried by AgentPrism itself). A multi-tenant implementation
