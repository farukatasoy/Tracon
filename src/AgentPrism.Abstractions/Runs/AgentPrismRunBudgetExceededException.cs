...
public sealed class AgentPrismRunBudgetExceededException : AgentPrismException
{
    ...
    public AgentPrismRunBudgetExceededException()
    {
    }

    /// <summary>Creates a new error.</summary>
    /// <param name="message">The error message.</param>
    public AgentPrismRunBudgetExceededException(string message)
        : base(message)
    {
    }
    ...
    public AgentPrismRunBudgetExceededException(string message, Exception innerException)
