...
/// therefore owes the one rule AgentPrism fixes for all of them — an unknown
...
/// </para>
/// <para>
/// <c>ModelProviderSettings.Validate</c> in <c>AgentPrism.Abstractions</c>
...
public abstract class ModelProviderSettingsContract : ModelProviderContract
{
    ...
    public void An_unsupported_provider_setting_is_rejected()
    {
        ...
        var exception = Should.Throw<AgentPrismException>(() => Provider.CreateChatClient(binding));
