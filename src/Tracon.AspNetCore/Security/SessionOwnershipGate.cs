...
/// <summary>
/// Applies <see cref="TraconSessionOwnershipOptions"/> at the HTTP
...
/// satisfies <see cref="TraconSessionOwnershipOptions.ManagementPolicy"/>
...
/// <see cref="TraconSessionOwnershipOptions.RefuseUnownedSessions"/>,
...
internal static class SessionOwnershipGate
{
    ...
    public static async ValueTask<string?> ResolveListOwnerFilterAsync(
        IOptionsMonitor<TraconSessionOwnershipOptions>? options,
    ...
    /// turned on carries a <see langword="null"/> owner, and Tracon cannot
        ...
        CancellationToken cancellationToken)
    {
        ...
        if (record.OwnerId is not { } ownerId)
        {
            ...
            // Tracon cannot invent an owner for it. Reachable by default,
    ...
    /// while
    /// <see cref="TraconSessionOwnershipOptions.RefuseUnownedSessions"/> is
    ...
    /// <see cref="TraconSessionOwnerRequiredException"/> writes when the
