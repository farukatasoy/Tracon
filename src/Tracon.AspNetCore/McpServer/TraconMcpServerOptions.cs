...
/// <summary>Settings for publishing Tracon agents as MCP tools.</summary>
/// <remarks>
...
public sealed class TraconMcpServerOptions
{
    ...
    /// <summary>
    /// MCP tool name prefix. Default <c>tracon</c>; the tool name becomes
    /// <c>{ToolNamePrefix}_{agent}</c>.
    /// </summary>
    public string ToolNamePrefix { get; set; } = "tracon";
