...
/// <c>TraconRunOptions.RunId</c>, and the same value
...
internal static class McpTaskRunAmbient
{
    ...
    /// <c>TraconRunContext.SetCurrent</c>'s shape — the same name the
...
internal static class McpTaskRunProvisioningFilter
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        var mcpOptions = services.GetRequiredService<IOptionsMonitor<TraconMcpServerOptions>>().CurrentValue;
        ...
        McpTaskRunAmbient.SetCurrent(new McpTaskRunProvisioning(TraconId.NewId(), agentName, tenantId));
