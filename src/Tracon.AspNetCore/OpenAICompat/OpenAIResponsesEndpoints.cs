...
/// agent resolution and persistence belong to Tracon. Because the wire
...
internal static class OpenAIResponsesEndpoints
{
        ...
        IdempotencyFilter idempotencyFilter)
    {
        builder.MapPost("/v1/responses", (
            ...
            .WithName("TraconOpenAIResponses")
    ...
    private static async Task<IResult> HandleAsync(
        ...
        IOptionsMonitor<TraconSessionOwnershipOptions>? sessionOwnershipOptions,
        string prefix,
        CancellationToken cancellationToken)
    {
        JsonElement body;
                ...
                .ConfigureAwait(false) is { } ownershipProblem)
        {
            return OpenAICompatSupport.Error(
                ...
                type: TraconSessionOwnerRequiredException.SessionOwnerRequiredErrorType);
        }
        ...
        catch (TraconSessionConflictException ex)
        {
            ...
            return OpenAICompatSupport.Error(
                ...
                ex.Message,
                type: TraconSessionConflictException.SessionConflictErrorType);
        }
        catch (Exception ex)
        {
