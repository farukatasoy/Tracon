...
internal static class MetaEndpoints
{
    ...
    public static void Map(IEndpointRouteBuilder builder, TraconEndpointOptions options, string prefix, TraconRolePolicies roles)
    {
        builder.MapGet("/api/meta", async Task<Ok<TraconMetaResponse>> (
                IAgentDefinitionStore definitions,
                IRunStore runs,
                ISessionStore sessions,
                IJobStore jobs,
                IOptionsMonitor<TraconSchedulingOptions> scheduling,
                ...
                [FromServices] IAuthorizationService? authorizationService) =>
            {
                ...
                return TypedResults.Ok(new TraconMetaResponse
                {
                    Version = Version,
                    Prefix = prefix,
                    Authentication = new TraconAuthenticationMeta
                    {
            ...
            .AllowAnonymous()
            .WithName("TraconMeta")
            .WithTags("Tracon", "Meta")
            .WithSummary("Reports the Tracon version, authentication method, active stores, and role authorizations.")
            .WithDescription(
    ...
    /// </remarks>
    private static async Task<TraconRoleMeta> ResolveRolesAsync(
