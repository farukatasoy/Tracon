...
internal static class UiEndpoints
{
    ...
    /// <param name="prefix">The normalized path prefix. Example: <c>/tracon</c>.</param>
    public static void Map(IEndpointRouteBuilder builder, ITraconUiProvider provider, string prefix)
    {
        var basePath = prefix + "/";
