...
export const VOICE_SUBPROTOCOL = 'tracon.voice.v1';

/** Prefix that carries the bearer token through the handshake. */
export const VOICE_TOKEN_PREFIX = 'tracon.token.';
 ...
 *
 * Tracon can be mounted under any prefix, so the address is derived from
...
const VOICE_STORAGE_PREFIX = 'tracon.voice.';
