...
// references FileParameter (TraconUploadAttachmentAsync) but does not
...
/// <summary>A file to upload with <see cref="TraconApiClient.TraconUploadAttachmentAsync"/>.</summary>
