...
{
    /// <summary>Gets AgentPrism's identifier for the session.</summary>
...
internal static class LiveVoiceEndpoints
{
    ...
    public static void Map(IEndpointRouteBuilder builder, AgentPrismRolePolicies roles)
    {
        builder.MapPost("/api/voice/live/sessions", CreateAsync)
            ...
            .WithName("AgentPrismLiveVoiceCreate")
            ...
            .WithDescription(
                ...
                "never reaches the browser. AgentPrism attaches a server-side control connection to the same " +
        ...
        builder.MapDelete("/api/voice/live/sessions/{voiceSessionId:guid}", CloseAsync)
            .RequireRole(roles.Operator)
            .RequireApiKeyScope(ApiKeyScope.RunsWrite)
            .WithName("AgentPrismLiveVoiceClose")
            .WithTags("AgentPrism", "Voice")
        ...
        builder.MapGet("/api/voice/live/sessions/{voiceSessionId:guid}", GetAsync)
            ...
            .WithName("AgentPrismLiveVoiceStatus")
            .WithTags("AgentPrism", "Voice")
            ...
            .WithDescription(
                ...
                "The duration is the provider's own number: AgentPrism does not carry a live " +
    ...
    private static async Task CreateAsync(HttpContext context, LiveVoiceSessionCreateRequest request)
    {
        ...
        catch (Exception exception) when (exception is AgentPrismException or HttpRequestException or TimeoutException)
        {
            // 🚨 HttpRequestException belongs here as much as AgentPrismException:
            ...
            // catch that named only AgentPrismException let a routine, caller-
    ...
    private static string Describe(Exception exception)
        => exception.InnerException is AgentPrismException inner
            ? inner.Message
            : exception.Message;
