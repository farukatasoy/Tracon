...
internal static class TriggerEndpoints
{
    ...
    public static void Map(IEndpointRouteBuilder builder, AgentPrismRolePolicies roles)
    {
        builder.MapGet("/api/triggers", ListAsync)
            ...
            .WithName("AgentPrismListInboundTriggers")
        ...
        builder.MapGet("/api/triggers/{name}", GetAsync)
            .RequireRole(roles.Admin)
            .RequireApiKeyScope(ApiKeyScope.PlatformRead)
            .WithName("AgentPrismGetInboundTrigger")
            .WithTags("AgentPrism", "Triggers")
        ...
        builder.MapPut("/api/triggers/{name}", SaveAsync)
            ...
            .WithName("AgentPrismSaveInboundTrigger")
            .WithTags("AgentPrism", "Triggers")
        ...
        builder.MapDelete("/api/triggers/{name}", DeleteAsync)
            .RequireRole(roles.Admin)
            .RequireApiKeyScope(ApiKeyScope.PlatformAdmin)
            .WithName("AgentPrismDeleteInboundTrigger")
            .WithTags("AgentPrism", "Triggers")
        ...
        CancellationToken cancellationToken)
    {
        ...
        var logger = loggerFactory.CreateLogger("AgentPrism.TriggerEndpoints");
        ...
        CancellationToken cancellationToken)
    {
        ...
        await WriteAuditOrThrowAsync(
            auditLog,
            actorResolver,
            loggerFactory.CreateLogger("AgentPrism.TriggerEndpoints"),
            tenants.TenantId,
