...
{
    private const string AttributeMetadataName = "Tracon.TraconToolAttribute";
        ...
        (ImmutableArray<ToolCandidate> Candidates, ImmutableArray<SourceLocation> CallSites) data)
    {
        ...
        context.AddSource("TraconGeneratedTools.g.cs", SourceWriter.WriteAggregator(emittable));
    }
