...
/// <remarks>
/// <para>
/// Tracon draws ownership at the TENANT level. Without this handler, every
...
/// teach Tracon that boundary — it asks the consumer to enforce their own.
/// </para>
/// <para>
/// One narrower boundary IS built in, for sessions only:
/// <see cref="TraconSessionOwnershipOptions"/> records which user opened a
