...
/// <c>TotalCost</c>. Pricing is not embedded in Tracon: it comes from
/// the model catalog or the <c>Tracon:Pricing</c> configuration.
/// </para>
/// </remarks>
...
/// <remarks>
/// The identity is opaque: Tracon repeats the value the consumer's
