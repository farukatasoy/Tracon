...
/// <c>TraconRunRecordingOptions.RecordToolPayloads</c> is on.</strong>
...
public enum RunEventType
{
    ...
    /// <c>TraconRunRecordingOptions.RecordToolPayloads</c> (see the type's
    ...
    /// (<c>TraconRunRecordingOptions.RecordReasoningDeltas</c>).
    /// </summary>
    ReasoningDelta = 23,
    ...
    /// it describes, and only when <c>TraconStructuredResponseOptions.MaxRepairAttempts</c>
    ...
    /// <c>Payload</c> carries whatever the consumer put there. Tracon
    ...
    /// <c>TraconRunRecordingOptions.RecordToolPayloads</c> off it still
    ...
    /// <see cref="Custom"/> is for events Tracon has no name for. A type
