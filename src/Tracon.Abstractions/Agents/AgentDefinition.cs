...
/// the security boundaries of Tracon: the user interface can create an agent, but
...
public sealed record AgentDefinition
{
    ...
    /// <see langword="null"/>, <c>TraconAgentGraphOptions.ChildDeadline</c>
    ...
    /// </summary>
    /// <remarks>
    /// Reading resources requires the <c>Tracon.Mcp</c> package to be registered
