...
public sealed record VoiceSessionRecord
{
    ...
    /// Tracon does not fabricate a duration.
    /// </summary>
    ...
    /// <see langword="null"/> when Tracon ran the conversation itself.
    /// </summary>
    ...
    /// resolved duration of audio Tracon transcribed; this one is how long the
    /// provider hosted the session. Different quantities, different fields. The number
    /// is the provider's — Tracon does not see the media of a live session and does
...
/// Tracon runs itself bills the synthesized characters.
/// </para>
/// <para>
...
/// </para>
/// <para>
/// The contract lives in <c>Tracon.Abstractions</c> because the HTTP
