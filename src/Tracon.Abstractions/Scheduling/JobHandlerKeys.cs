...
/// the <c>tracon.job.handler_key</c> metric tag) and how the background
...
/// starts with <c>tracon.</c>, and a consumer picks its own prefix
...
{
    /// <summary>The prefix reserved for the handlers Tracon itself ships.</summary>
    /// <remarks>
    ...
    /// <summary>Every key Tracon itself ships, in no particular order.</summary>
    ...
    /// </summary>
    /// <param name="key">The candidate key.</param>
    /// <returns><see langword="true"/> if the key is reserved for Tracon.</returns>
