...
/// <remarks>
/// <para>
/// The abstraction lives in <c>Tracon.Abstractions</c> because
/// <c>AgentDefinitionCompiler</c> (<c>Tracon.Core</c>) wants to add MCP
/// resources to the context but does not depend on the <c>Tracon.Mcp</c>
