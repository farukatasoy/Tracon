...
/// <c>Tracon.Workflows</c> package. This is the same pattern established
...
/// through Tracon's own <see cref="RunEvent"/> type; the conversion from
/// MAF events happens inside <c>Tracon.Workflows</c>.
/// </para>
/// <para>
