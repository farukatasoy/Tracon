...
/// <summary>Settings for Tracon's SQLite persistence layer.</summary>
/// <remarks>
/// Validation is done manually in <see cref="TraconSqliteOptionsValidator"/>;
...
public sealed class TraconSqliteOptions
{
    ...
    /// <summary>
    /// The SQLite connection string (example: <c>Data Source=tracon.db</c>).
    /// </summary>
    /// <remarks>
    ...
    /// database instead, e.g. <c>Data Source=file:tracon?mode=memory&amp;cache=shared</c>
    /// or <c>Data Source=file::memory:?cache=shared</c>. This setting is rejected
    /// during validation (<see cref="TraconSqliteOptionsValidator"/>).
    /// </remarks>
    ...
    /// <summary>
    /// The prefix added to the names of Tracon tables. The consumer's own
    ...
    /// </remarks>
    public string TablePrefix { get; set; } = "tracon_";
