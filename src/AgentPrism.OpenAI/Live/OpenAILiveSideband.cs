...
/// are deliberately ignored — consuming them would make AgentPrism a party to media
...
internal sealed class OpenAILiveSideband : ILiveVoiceSideband
{
    ...
    /// <summary>Translates one provider frame into an AgentPrism event.</summary>
    /// <param name="message">The raw frame.</param>
    /// <returns>The event, or <see langword="null"/> when the frame carries nothing AgentPrism models.</returns>
    /// <remarks>
