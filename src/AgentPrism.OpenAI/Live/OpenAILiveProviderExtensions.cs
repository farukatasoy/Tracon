...
/// <summary>Extensions that add OpenAI's live voice provider to the AgentPrism chain.</summary>
/// <remarks>
/// <para>
...
public static class OpenAILiveProviderExtensions
{
    ...
    /// <param name="configurationSection">The <c>AgentPrism:Providers:OpenAI:Live</c> section.</param>
    ...
    /// </code>
    /// </example>
    public static IAgentPrismBuilder UseOpenAILive(
    ...
    public static IAgentPrismBuilder UseOpenAILive(this IAgentPrismBuilder builder)
    {
        ArgumentNullException.ThrowIfNull(builder);
    ...
    private static IAgentPrismBuilder UseOpenAILiveCore(
