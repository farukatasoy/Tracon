...
internal sealed class GoogleImageGenerator : IImageGenerator
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        {
            throw new AgentPrismException("Image-generation prompt cannot be empty.");
        }
        ...
        {
            throw new AgentPrismException("Google image-generation model is required.");
        }
        ...
        foreach (var generated in response.GeneratedImages ?? [])
        {
            ...
            {
                throw new AgentPrismException("Google image generation returned no image bytes.");
            }
