...
/// <summary>Settings for Tracon's SQL Server persistence layer.</summary>
/// <remarks>
/// Validation is done by hand in <see cref="TraconSqlServerOptionsValidator"/>;
...
public sealed class TraconSqlServerOptions
{
    ...
    /// <summary>
    /// The schema Tracon's tables are created in. The consumer's <c>dbo</c>
    /// schema is never touched, under any circumstances.
    /// </summary>
    /// <remarks>
    /// Even though SQL Server allows a wider set of identifiers, Tracon
