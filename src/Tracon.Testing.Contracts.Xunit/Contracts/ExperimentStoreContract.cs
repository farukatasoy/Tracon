...
public abstract class ExperimentStoreContract : TenantIsolationContract<IExperimentStore>
{
    ...
    public async Task Running_experiment_cannot_be_updated()
    {
        ...
        await Should.ThrowAsync<TraconException>(async () => await Store.SaveAsync(Experiment("d1")));
    }
    ...
    public async Task Second_start_for_same_agent_is_rejected()
    {
        ...
        await Should.ThrowAsync<TraconException>(async () => await Store.StartAsync(TenantId, "d2"));
    }
    ...
    public async Task Non_running_experiment_cannot_be_stopped()
    {
        ...
        await Should.ThrowAsync<TraconException>(async () => await Store.StopAsync(TenantId, "d1"));
    }

    [Fact]
    public async Task Nonexistent_experiment_cannot_be_started()
        => await Should.ThrowAsync<TraconException>(async () => await Store.StartAsync(TenantId, "missing"));
    ...
    public async Task Running_experiment_cannot_be_deleted()
    {
        ...
        await Should.ThrowAsync<TraconException>(async () => await Store.DeleteAsync(TenantId, "d1"));
    }
    ...
    public async Task Canary_ramp_is_rejected_on_a_non_running_experiment()
    {
        ...
        await Should.ThrowAsync<TraconException>(async () => await Store.AdvanceCanaryRampAsync(
            TenantId,
            "d1",
            [
                new ExperimentVariant { Name = "control", Version = 1, Weight = 75 },
    ...
    public async Task Experiment_lifecycle_does_not_leak_across_tenants()
    {
        ...
        await Should.ThrowAsync<TraconException>(async () => await Store.StartAsync("tenant-b", "campaign"));
        ...
        await Should.ThrowAsync<TraconException>(async () => await Store.StopAsync("tenant-b", "campaign"));
