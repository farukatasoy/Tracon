import type * as Generated from '@agentprism/client';
 ...
 *
 * Every type below is generated from `docs/openapi/agentprism.json` by a
...
export type AgentDefinition = Fix<Generated.AgentDefinition, 'callableAgentNames' | 'mcpResourceUris' | 'metadata' | 'origin' | 'skillNames' | 'toolNames' | 'version'> & { compaction: CompactionSettings | null; harness: HarnessSettings | null; memory: MemorySettings | null; model: ModelBinding };
...
export type AgentPrismDiagnosticsReport = Fix<Generated.AgentPrismDiagnosticsReport, 'agentCount' | 'registeredPersistenceProviders' | 'toolCount'>;
export type AgentSkillDefinition = Fix<Generated.AgentSkillDefinition, 'createdAt' | 'enabled' | 'id' | 'metadata' | 'scripts' | 'updatedAt' | 'version'> & { resources: AgentSkillResourceDefinition[] };
...
export type JobRecord = Fix<Generated.JobRecord, 'attempt' | 'doneItems' | 'failedItems' | 'maxAttempts' | 'payload' | 'totalItems'>;
export type JobSchedule = Fix<Generated.JobSchedule, 'enabled' | 'id' | 'payload' | 'timeZone'>;
...
export type SkillScriptGrant = Fix<Generated.SkillScriptGrant, 'grantedAt' | 'id'>;
