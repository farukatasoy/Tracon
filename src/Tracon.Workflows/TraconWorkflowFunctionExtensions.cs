...
public static class TraconWorkflowFunctionExtensions
{
    /// <summary>
    ...
    /// <see cref="TraconWorkflowsBuilderExtensions.AddWorkflow"/> draws
    ...
    /// </example>
    /// </remarks>
    public static ITraconBuilder AddWorkflowFunction<TInput, TOutput>(
