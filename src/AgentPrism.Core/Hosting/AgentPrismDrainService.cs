...
/// or <see cref="AgentPrismDrainOptions.Timeout"/> elapses. For this wait to
...
/// LAST in <c>AgentPrismServiceCollectionExtensions.AddAgentPrism</c> for
/// exactly this reason.
/// </para>
/// <para>
/// While <see cref="AgentPrismDrainOptions.Enabled"/> is <see langword="false"/>
...
/// </para>
/// </remarks>
internal sealed class AgentPrismDrainService(
    IRunCancellationRegistry registry,
    IOptionsMonitor<AgentPrismDrainOptions> optionsMonitor,
    IHostApplicationLifetime? lifetime = null,
    TimeProvider? timeProvider = null,
    ILogger<AgentPrismDrainService>? logger = null) : IHostedService, IAgentPrismDrainState
{
