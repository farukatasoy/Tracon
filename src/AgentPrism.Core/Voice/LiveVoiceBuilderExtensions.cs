...
/// That layer has AgentPrism transcribe, run and synthesize; this one has the
...
public static class LiveVoiceBuilderExtensions
{
    ...
    /// <param name="configurationSection">The <c>AgentPrism:Voice:Live</c> section.</param>
    ...
    /// </code>
    /// </example>
    public static IAgentPrismBuilder UseLiveVoice(
    ...
    public static IAgentPrismBuilder UseLiveVoice(this IAgentPrismBuilder builder)
    {
        ArgumentNullException.ThrowIfNull(builder);
    ...
    private static IAgentPrismBuilder UseLiveVoiceCore(
