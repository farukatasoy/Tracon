...
public static class DocumentChannelMessageBuilder
{
    ...
    private const string BeginMarker = "-----BEGIN AGENTPRISM DOCUMENT-----";
    private const string EndMarker = "-----END AGENTPRISM DOCUMENT-----";
    private const string EscapedBeginMarker = "-----BEGIN AGENTPRISM DOCUMENT (escaped)-----";
    private const string EscapedEndMarker = "-----END AGENTPRISM DOCUMENT (escaped)-----";
