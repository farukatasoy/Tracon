...
/// once <c>AgentPrismSkillScriptOptions.AllowStoredScripts</c> is on. Saving
...
internal sealed class AuditingAgentSkillStore : IAgentSkillStore, IAuditDecorated
{
    ...
    private static string Serialize(AgentSkillDefinition skill)
        => JsonSerializer.Serialize(skill, AgentPrismCoreJsonContext.Default.AgentSkillDefinition);
}
