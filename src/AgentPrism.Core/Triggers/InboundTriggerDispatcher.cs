...
internal sealed class InboundTriggerDispatcher
{
    ...
    /// <param name="timestampHeader">The <c>X-AgentPrism-Timestamp</c> header value.</param>
    /// <param name="signatureHeader">The <c>X-AgentPrism-Signature</c> header value.</param>
