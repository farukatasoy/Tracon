...
/// evaluation catalog onto AgentPrism's <see cref="IRunJudge"/> contract.
/// </summary>
/// <remarks>
/// <para>
/// The evaluator is used, not wrapped: AgentPrism builds no parallel type
...
/// token AgentPrism supplies as the call budget. Like the built-in judge, it
