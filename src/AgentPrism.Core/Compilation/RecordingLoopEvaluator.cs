...
/// <summary>
/// The single <see cref="LoopEvaluator"/> AgentPrism hands the harness. It runs
...
/// accepts many evaluators and aggregates them itself, but AgentPrism needs
...
internal sealed class RecordingLoopEvaluator : LoopEvaluator
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        foreach (var criterion in Criteria)
        {
            ...
            catch (Exception ex)
            {
                ...
                _logger.LogError(
                    ex,
                    "AgentPrism loop criterion '{Kind}' of agent '{Agent}' failed to evaluate on iteration " +
        ...
        CancellationToken cancellationToken)
    {
        ...
        var payload = JsonSerializer.Serialize(
            ...
            AgentPrismCoreJsonContext.Default.LoopIterationCompletedEventPayload);
