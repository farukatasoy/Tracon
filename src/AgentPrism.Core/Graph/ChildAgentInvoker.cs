...
public sealed class ChildAgentInvoker : AIAgent
{
    ...
    /// <see cref="SubAgentSettings.ChildDeadline"/>/<see cref="AgentPrismAgentGraphOptions.ChildDeadline"/>.
    /// Must be greater than zero.
    /// </param>
    /// <param name="waitTimeout">
    /// The hard wait cutoff (144.1 layer 2), resolved beforehand from
    /// <see cref="SubAgentSettings.WaitTimeout"/>/<see cref="AgentPrismAgentGraphOptions.WaitTimeout"/>.
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        // 144.1 layer 1: the caller's token and AgentPrism's own deadline are
        ...
        CancellationToken cancellationToken)
    {
        ...
        var payload = JsonSerializer.Serialize(
            ...
            AgentPrismCoreJsonContext.Default.ChildRunTimedOutEventPayload);
