...
/// </para>
/// <para>
/// A rejection <strong>throws</strong> <see cref="AgentPrismException"/> with
...
public sealed class ValidatingAIFunction : DelegatingAIFunction
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        if (!result.IsValid)
        {
            throw new AgentPrismException(result.Reason ?? "This tool call's arguments were rejected.");
        }
