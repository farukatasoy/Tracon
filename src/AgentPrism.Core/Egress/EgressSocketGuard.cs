...
public sealed class EgressSocketGuard
{
    ...
    /// <exception cref="AgentPrismException">The target resolves to a rejected address.</exception>
        ...
        CancellationToken cancellationToken)
    {
        ...
        {
            throw new AgentPrismException(verdict.Reason ?? "The outbound target was rejected.");
        }
